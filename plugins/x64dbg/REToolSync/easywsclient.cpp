...
WebSocket::pointer WebSocket::from_url(const std::string& url, const std::string& origin, const std::string& userAgent) {
    return ::from_url(url, true, origin, userAgent);
}

WebSocket::pointer WebSocket::from_url_no_mask(const std::string& url, const std::string& origin, const std::string& userAgent) {
